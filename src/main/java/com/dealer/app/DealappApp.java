...
public class DealappApp {

    private static final Logger log = LoggerFactory.getLogger(DealappApp.class);

    private final Environment env;

    public DealappApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DealappApp.class);
